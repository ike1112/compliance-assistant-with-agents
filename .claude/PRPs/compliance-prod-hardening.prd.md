...
| 3 | RAG evaluation harness — retrieval / generation / task-level gold sets + LLM-as-judge + CI gate; decides the real chunking value | 1 | in-progress | `.claude/PRPs/plans/phase-rag-evaluation-harness.plan.md` | GAP-GENAI-02, GAP-GENAI-03 |
